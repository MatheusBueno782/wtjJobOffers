...
Repo.insert! %Offer{ profession_id: String.to_integer(prof_id), contract: contract, description: desc, latitude: String.to_float(lat), longitude: String.to_float(long)}
end)
